...
// @updateURL    https://yata.yt/static/userscripts/gym-perks.user.js
...
(function() {
    'use strict';
    let faction_id = ""
    let html = `<img style="margin-top: 10px; border-radius: 5px;" src="https://yata.yt/media/posters/${faction_id}-gym.png?cache=1" />`;
    $("#gymroot").append(html);
})();
