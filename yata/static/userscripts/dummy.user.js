...
// @description  Does nothing, just a dummy script for design
...
// @grant        GM_addStyle
// @connect      yata.yt
// @require      https://yata.yt/static/userscripts/userscripts.style.js
// @resource     YATA_CSS https://yata.yt/static/userscripts/userscripts.style.css
// ==/UserScript==
...
(function() {
  ...
  const sendJSON = (json)=>{
      ...
      if (key.length != 16) {
          errorKey("Please insert your API key");
          return;
      }
      GM_xmlhttpRequest({
          method: "POST",
          url: "https://yata.yt/chain/importUpgrades/",
