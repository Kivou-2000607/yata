...
def manageCompany(request):
    ...
    if request.session.get('player') and request.method == 'POST':
        ...
        if company is None:
            ...
            return render(request, 'company/supervise/share.html', {"error": "You need to be the director to do that"})
        ...
        return render(request, 'company/supervise/share.html', {"error": "Unkown request argument"})
