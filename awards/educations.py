educations = {
    ...
    "47": {
        ...
        "description": "Skill? Surely that's only applied in computer games? Wrong. You'd be surprised of what we can help you do.",
                "money_cost": 1750,
                "tier": 2,
                "duration": 1814400,
                "results": {
    ...
    "62": {
        ...
        "description": "To finish off your course you will learn more into cryptology, in particular how to completely hide your tracks and stay anonymous within the digital world.",
                "money_cost": 5000,
                "tier": 3,
                "duration": 4233600,
                "results": {
    ...
    "80": {
        "name": "A Study of War and Technology",
    ...
    "82": {
        ...
        "description": "Here you will learn the history, science, evolution and technology behind the machine gun.",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Machine Guns"
                    ],
                    "manual_labor": [
                        "30"
                    ],
    ...
    "83": {
        "name": "Study of Sub Machine Guns",
        "description": "The bastard love child of a pistol and a machine gun, generally used by law enforcement and tactical teams. Learn how they came about with this course.",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Sub-Machine guns"
                    ],
                    "manual_labor": [
                        "30"
                    ],
    ...
    "84": {
        ...
        "description": "Contrary to popular belief, a pistol is not the same as a handgun. Learn this and more with this popular course.",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Pistols"
                    ],
                    "manual_labor": [
                        "30"
                    ],
    ...
    "85": {
        ...
        "description": "Aimed to be shot from the shoulder and used during warfare, hunting and shooting sports there is more to this gun than meets the eye.",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Rifles"
                    ],
                    "manual_labor": [
                        "30"
                    ],
    ...
    "86": {
        ...
        "description": "These weapons deliver a huge blow. Originating in ancient times, heavy artillery bases its firepower on using an engine of sort to discharge the weapons.",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Heavy Artillery"
                    ],
                    "manual_labor": [
                        "30"
                    ],
    ...
    "87": {
        ...
        "description": "Finally, which weapon will you specialise in. Find out in this course.",
                "money_cost": 5000,
                "tier": 3,
                "duration": 4233600,
                "results": {
    ...
    "113": {
        ...
        "description": "You'll need this to get around the city. Our crash course should give you a licence without fail.\t",
                "money_cost": 1500,
                "tier": 2,
                "duration": 1209600,
                "results": {
    ...
    "121": {
        ...
        "description": "Education only broadens the mind. The rest is up to you. In this final course you will learn how to research and make the most of what you discover.",
                ...
                "results": {
                    "perk": [
                        "Gain a 10% working stat increase bonus for all further educations that are completed"
                    ],
                    "manual_labor": [
                        "75"
                    ],
    ...
    "123": {
        "name": "Ivory Crafting",
        "description": "The teeth and tusks of the 'ebur', Latin for elephant can be very beautiful when carved. On this course you will learn the required skills to do so.",
                "money_cost": 3500,
                "tier": 2,
                "duration": 1814400,
                "results": {
    ...
    "124": {
        "name": "Dual Wield Melee Course",
        "description": "Join Master Keneshi and learn the fine art of wielding dual weapons with greater accuracy.",
                "money_cost": 50000000,
                "tier": 3,
                "duration": 1209600,
                "results": {
                    "perk": [
                        "Gain dual melee weapon"
                    ],
                    "manual_labor": [
                        "75"
                    ],
    ...
    "125": {
        ...
        "description": "One of the primary weapons used in close-quarter combat. They fire loads consisting of small metal balls held in a cartridge. Learn more in this course!",
                ...
                "results": {
                    "perk": [
                        "Gain a 5% increase in accuracy with Shotguns"
                    ],
                    "manual_labor": [
                        "30"
                    ],
